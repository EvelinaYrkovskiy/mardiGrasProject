...
export const MEDIA_PAGE = document.getElementById("media-page");
export const FAQ_PAGE = document.getElementById("FAQ-page");
export const CONTACT_PAGE = document.getElementById("contact-page");
export const ERROR404_PAGE = document.getElementById("error-404-page");
...
export const MEDIA_PAGE_LINK = document.getElementById("media-page-link");
export const FAQ_PAGE_LINK = document.getElementById("FAQ-page-link");
export const CONTACT_PAGE_LINK = document.getElementById("contact-page-link");
